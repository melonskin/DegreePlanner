User.create( :name => "Johana", :email => "xxx@tamu.edu", :password => 111111, :password_confirmation => 111111)
User.create( :name => "Yining", :email => "yyy@tamu.edu", :password => 111111, :password_confirmation => 111111)
User.create( :name => "Andres", :email => "xxx2@tamu.edu", :password => 111111, :password_confirmation => 111111)
User.create( :name => "Shijin", :email => "yyy1@tamu.edu", :password => 111111, :password_confirmation => 111111)
User.create( :name => "Jingjia", :email => "xxx3@tamu.edu", :password => 111111, :password_confirmation => 111111)
...
Package.create( :number => 4, :no_required => 1, :program_id => 2)
Package.create( :number => 5, :no_required => 1, :program_id => 2)
Package.create( :number => 6, :no_required => 1, :program_id => 3)
...
PackageCourseship.create( :course_id => 3, :package_id => 2)
PackageCourseship.create( :course_id => 4, :package_id => 2)
PackageCourseship.create( :course_id => 5, :package_id => 2)
PackageCourseship.create( :course_id => 1, :package_id => 3)
PackageCourseship.create( :course_id => 6, :package_id => 4)
PackageCourseship.create( :course_id => 2, :package_id => 4)
PackageCourseship.create( :course_id => 1, :package_id => 5)
PackageCourseship.create( :course_id => 3, :package_id => 5)
PackageCourseship.create( :course_id => 1, :package_id => 6)
PackageCourseship.create( :course_id => 2, :package_id => 6)
PackageCourseship.create( :course_id => 3, :package_id => 6)
