...
#Scenario: go to the Profile page under the Account
#    Given I am on the user page for "Lilei"
#    And I follow "View your information"
#    Then I should be on the required courses page
...
# Scenario: successfully add selective courses in plan page
#   ###################################
#   #add snippet in order to have student profile
#   #TODO: add student profile in background
...
#     #############################################
#     #jump to plan page
#     Then I should on the plan page for "Student"
#     Then I fill in "search" with "CSCE606"
#     And  I select "fall" from "semester"
#     And  I select "2017" from "year"
#     Then I should see "CSCE606 Software Engineering"   
    
# Scenario: fail to add selective courses in plan page due to non-exist course ID
#   ###################################
#   #add snippet in order to have student profile
#   #TODO: add student profile in background
#     Given I am on the signup page
...
#     #jump to plan page
#     Then I should on the plan page for "Student"
#     Then I fill in "search" with "nonexist"
#     And  I select "fall" from "semester"
#     And  I select "2017" from "year"
#     Then I should see "The input course ID is not valid"  