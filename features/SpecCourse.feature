...
Background: users in database
    ...
    Scenario: not valid special courses
        ...
        Then I should see "Total course hours: 22/30"
        And I select "CSCE691 Research" from "course"
        And I select "Spring" from "semestersc"
        And I select "2018" from "yearsc"
        And I fill in "credit" with "16"
        And I press "Add special course"
        Then I should see "CSCE691 Research should be within"